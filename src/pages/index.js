...
export default function Home() {
  return (
    ...
    <meta name="google-site-verification" content="pGx796kimjETeKepSZ8aFLC06e9RiO_ua7k590fW_c8" />
      ...
      <Image src={lightBulb} alt="Rakshit" className='w-full h-auto ' /></div>
      </main>
     </>
  )
}
