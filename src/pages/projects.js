...
import Schedulrr from "../../public/images/projects/Schedulrr.png"
...
const FeaturedProject = ({type,title,summary,img,link,github,videolink}) => {
return (
    ...
    {/* <div className='absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark dark:bg-light rounded-br-3xl xs:-right-2 sm::h-[102%] xs:w-full xs:rounded-[1.5rem]' /> */}
        ...
        <div  className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6  '>
            ...
            <div className='mt-2 flex items-center'>
                ...
                <Link href={videolink} target='_blank' className='ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark sm:px-4 sm:text-base '>Watch Video</Link>
            </div>
...
" type="Project 9"  img={FbLoginPage} github="https://github.com/RakshitDevra/Facebookclone" />
                </div>
